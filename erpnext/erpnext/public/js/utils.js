...
erpnext.utils.update_child_items = function (opts) {
	console.log("update_child_items function is running.");
	const frm = opts.frm;
	...
	this.data = frm.doc[opts.child_docname].map((d) => {
		return {
			...
			"item_name": d.item_name, // New field for Item Name
	...
	console.log("Data for child items:", this.data);
	...
	const fields = [{
		...
		fieldtype: 'Data',  // New field for Item Name
		fieldname: 'item_name',
		read_only: 0,
		label: __('Item Name'),
	},
	...
	console.log("Fields for the dialog:", fields);
