	...
	def set_latest_location_and_custodian_in_asset(self):
		...
		for d in self.assets:
			...
			latest_movement_entry = frappe.db.sql(
				"""
				SELECT asm_item.target_location, asm_item.to_employee, asm_item.to_employee_name, asm_item.to_department
			...
			frappe.db.set_value("Asset", d.asset, "custodian_name", frappe.db.get_value("Employee", current_employee, "employee_name"))
			frappe.db.set_value("Asset", d.asset, "department", frappe.db.get_value("Employee", current_employee, "department"))
