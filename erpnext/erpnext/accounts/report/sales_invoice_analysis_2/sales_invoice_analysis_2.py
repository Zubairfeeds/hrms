...
def _execute(filters=None, additional_table_columns=None, additional_query_columns=None):
	...
	# 					"stock_qty": 0,
	# 					"rate_total": 0,
	# 					# Add more fields you want to aggregate
	# 				}
	# 			grouped_items[item_code]["stock_qty"] += item.get("stock_qty")
	# 			grouped_items[item_code]["rate_total"] += item.get("rate") * item.get("stock_qty")
	# 			# Aggregate other fields similarly

	# 		# Replace the item_list with the aggregated items
	# 		item_list = list(grouped_items.values())
