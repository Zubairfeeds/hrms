...
def get_gross_salary(employee_name):
    # Fetch the gross monthly salary from the Salary Structure Assignment
    salary_structure_assignment = frappe.get_value('Salary Structure Assignment',{'employee_name': employee_name, 'docstatus': 1},'gross_monthly_salary'
    )
