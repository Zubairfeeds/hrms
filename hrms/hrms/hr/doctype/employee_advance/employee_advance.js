...
// 		// When an employee is selected, fetch the gross monthly salary from the Salary Structure Assignment
// 		frappe.call({
// 			method: 'hrms.hr.doctype.employee_advance.employee_advance.get_gross_salary',
// 			args: {
// 				employee_name: frm.doc.employee_name,
// 			},
// 			callback: function (r) {
// 				if (r.message) {
// 					frm.set_value('gross_monthly_salary', r.message);

// 					if (frm.doc.advance_type == 'Employee Advance') {
