...
doc_events = {
	...
	"Journal Entry": {
		...
		"on_update_after_submit": "hrms.hr.doctype.expense_claim.expense_claim.update_payment_for_expense_claim",
		"on_cancel": [
			#"hrms.hr.doctype.expense_claim.expense_claim._ref_doc_from_salary_slip",
			# "hrms.hr.doctype.full_and_final_statement.fuupdate_payment_for_expense_claim",
			# "hrms.payroll.doctype.salary_slip.salary_slip.unlinkll_and_final_statement.update_full_and_final_statement_status",
		],
	},
	...
	"Overtime": {
        ...
        "on_submit": "zfpl.zfpl.doctype.overtime.overtime.validate"

    }
    
	# "Payroll Entry":
    #   {
    #       "on_submit": "hrms.payroll.doctype.salary_slip.salary_slip.set_gross_salary_in_salary_slip",
    #    },
