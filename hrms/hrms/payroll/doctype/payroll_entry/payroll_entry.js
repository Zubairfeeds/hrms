...
// 		var employee_name = child.employee;
// 		console.log('test')

// 		frappe.call({
// 			method: 'hrms.payroll.doctype.payroll_entry.payroll_entry.get_gross_salary',
// 			args: {
// 				employee: employee_name
// 			},
// 			callback: function (response) {
// 				if (response.message) {
// 					frappe.model.set_value(cdt, cdn, 'gross_monthly_salary', response.message);
// 				}
// 			}
// 		});
// 	}
...
frappe.ui.form.on('Payroll Entry', {
	before_save: function (frm) {
		// Iterate through each row in the 'Payroll Employee Detail' child table
		$.each(frm.doc.employees || [], function (i, employee_detail) {
			var employee_name = employee_detail.employee;
			...
			frappe.call({
				...
				callback: function (response) {
					if (response.message) {
						frappe.model.set_value('Payroll Employee Detail', employee_detail.name, 'gross_monthly_salary', response.message);
					}
				}
			});
		});
